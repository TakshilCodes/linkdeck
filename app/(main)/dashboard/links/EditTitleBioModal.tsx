...
export default function EditTitleBioModal({
    ...
    useEffect(() => {
        ...
        const onKeyDown = (e: KeyboardEvent) => {
            if (e.key === "Escape" && warningMessage === null) onClose();
        };
    ...
    const handleSave = () => {
        startTransition(async () => {
            ...
            if (res.success) {
                ...
                setWarningMessage(res.message || "Something went wrong");
            }
        });
    };
    ...
    return createPortal(
        <>
            ...
            <WarningModal
                ...
                description={warningMessage || "Something went wrong"}
                confirmLabel="Got it"
                hideCancel
                lockScroll={false}
